  ...
  return (
    <SafeAreaView className='bg-[#6C85D7] flex flex-1'>
      ...
      <View className='flex flex-col px-10 mt-[107px] h-[166px] justify-between'>
        <TouchableOpacity className='bg-slate-50 w-[347px] h-[60px] items-center justify-center'>
          <Text className='font-Nunito_Bold text-2xl text-[#1E1E1E]'>Login</Text>
        </TouchableOpacity>
        <TouchableOpacity className='bg-[#8A9EDF] w-[347px] h-[60px] items-center justify-center border-[#1e1e1e4d] border-1'>
